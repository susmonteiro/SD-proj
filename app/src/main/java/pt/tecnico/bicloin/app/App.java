...
public class App {
    ...
    private static HashMap<String, Tag> _tags;
    ...
    public static void start(String hubIP, int hubPORT, String userID, String userPhoneNumber, 
		...
		try (Scanner scanner = new Scanner(System.in)) {
            String input;
            debug("Insira um comando ou escreva exit para sair");
            do {
                System.out.print(">");
                input = scanner.next();
                //debug(input);
    ...
    //FAZER UMA CLASSE PARA TAG PARA PODER TER VARIAS TAGS?
